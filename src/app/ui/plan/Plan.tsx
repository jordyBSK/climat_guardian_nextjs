...
`}
      ...
      >
        ...
        <g className="transition-all duration-500 ease-in-out text-blue-300 text-[3px]">
          <g id="icon-light" fill="currentcolor">
            <circle cx="78" cy="80" r="3" opacity="1"/>
            <circle cx="78" cy="80" r="4" opacity=".3"/>
            <circle cx="78" cy="80" r="6" opacity=".1"/>
          </g>

          <g id="icon-light" fill="currentcolor">
            <circle cx="16" cy="59" r="3" opacity="1"/>
            <circle cx="16" cy="59" r="4" opacity=".3"/>
            <circle cx="16" cy="59" r="6" opacity=".1"/>
          </g>

          <g id="icon-light" fill="currentcolor">
            <circle cx="82" cy="42" r="3" opacity="1"/>
            <circle cx="82" cy="42" r="4" opacity=".3"/>
            <circle cx="82" cy="42" r="6" opacity=".1"/>
          </g>

          <g id="icon-light" fill="currentcolor">
            <circle cx="51" cy="42" r="3" opacity="1"/>
            <circle cx="51" cy="42" r="4" opacity=".3"/>
            <circle cx="51" cy="42" r="6" opacity=".1"/>
          </g>
        </g>
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-80">
          <div className="grid gap-4">24&#8451;</div>
        </PopoverContent>
      </Popover>
    </div>
  );

  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        ...
        <main className="grid flex-1 xl:gap-4 overflow-auto p-4 lg:flex-2 lg:grid-cols-1 xl:grid-cols-3">
          <div
            className="relative items-start gap-8 md:flex"
          ...
          <div className="flex h-full min-h-[50vh] gap-y-5 flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
            <div className="h-1/2 hover:bg-gray-300 text-center content-center border-2 border-gray-300 rounded-2xl">
              <h1>1graphs</h1>
            </div>
            <div className="h-1/2 hover:bg-gray-300 text-center content-center border-2 border-gray-300 rounded-2xl">
              <h1>2Graphs</h1>
